...
public class SprintResourceIT {
     ...
     *
     * @see com.superleague.microservice.repository.search.SprintSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchSprint() throws Exception {
        ...
        // Initialize the database
        sprintRepository.saveAndFlush(sprint);
        when(mockSprintSearchRepository.search(queryStringQuery("id:" + sprint.getId())))
